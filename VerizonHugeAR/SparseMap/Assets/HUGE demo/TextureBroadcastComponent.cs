...
namespace TextureSharing
{
    public class TextureBroadcastComponent : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        private UnityAction changeListener;

        void Awake ()
        {
            changeListener = new UnityAction (drawChange);
        }
        ...
        void Start()
        {
            EventManager.StartListening ("draw", changeListener);
